        var datetime = document.getElementById('selectbox1').value;
        var token = document.getElementById('selectbox2').value;
        var show = document.getElementById('selectbox3').value; //active or all
